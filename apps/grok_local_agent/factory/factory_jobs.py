...
STATES = (
    "CREATED", "ANALYZING", "DESIGNING", "DESIGNING_DSP", "SPEC_READY",
    "GENERATING_SPEC", "GENERATING_CODE", "GENERATING", "WAITING_PERMISSION",
    "BUILDING", "BUILD_FAILED", "VALIDATING", "VALIDATION_FAILED",
    "AUDIO_TESTING", "HOST_TESTING", "REGRESSION_TESTING",
